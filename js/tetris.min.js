...
$jscomp.polyfill=function(d,h,k,l){if(h){k=$jscomp.global;d=d.split(".");for(l=0;l<d.length-1;l++){var n=d[l];n in k||(k[n]={});k=k[n]}d=d[d.length-1];l=k[d];h=h(l);h!=l&&null!=h&&$jscomp.defineProperty(k,d,{configurable:!0,writable:!0,value:h})}};
...
(function(){var d=!1,h=!1,k=!1,l=!1,n=!1,g="",f=1,p=0,w=window.randomIntFromInterval(0,6),q="",x=!0,I=document.getElementById("gameBoard"),z=950,e=[],r=function(){return Array.from(document.querySelectorAll(".moving"))},L=function(a){switch(a.key){case "ArrowLeft":B(-1);break;case "ArrowRight":B(1);break;case " ":z=100;break;case "r":case "R":case "ArrowUp":if(!l||"sq"===g)break;J();break;case "h":x&&(x=!1,document.getElementById("heldPieceImage").classList.remove("hidden"),C(),""===q?(q=g,D(),A(!1,
q)):(a=q,q=g,A(!0,a),D()));break;case "ArrowDown":l&&K()}},E=function(a,b,c){document.getElementById(a+"-"+b).classList.add("moving");document.getElementById(a+"-"+b).classList.add(c);e[a][b]=1},t=function(a){return a.some(function(a){return 0>a[0]||9<a[0]||0>a[1]||19<a[1]||0!==e[a[0]][a[1]]})},u=function(a,b){a.forEach(function(a){E(a[0],a[1],b)})},J=function(){var a=[];r().forEach(function(b){var c=$jscomp.makeIterator(m(b.id)),d=c.next().value,c=c.next().value;document.getElementById(d+"-"+c).classList.remove("moving");
e[d][c]=0;a.push([d,c]);y(b)});if("st"===g){var b=M(a);t(b)?u(a,"cyan"):v(b,"cyan")}else"tt"===g?(b=N(a),t(b)?u(a,"blue"):v(b,"blue")):"rl"===g?(b=O(a),t(b)?u(a,"orange"):v(b,"orange")):"ml"===g?(b=P(a),t(b)?u(a,"green"):v(b,"green")):"rz"===g?(b=Q(a),t(b)?u(a,"purple"):v(b,"purple")):"mz"===g&&(b=R(a),t(b)?u(a,"red"):v(b,"red"))},v=function(a,b){f++;a.forEach(function(a){E(a[0],a[1],b)});5===f&&(f=1)},R=function(a){var b=[];1===f?(b.push([a[0][0]+1,a[0][1]-1]),b.push([a[1][0],a[1][1]-2]),b.push([a[2][0]+
1,a[2][1]+1]),b.push([a[3][0],a[3][1]])):2===f?(b.push([a[0][0]+2,a[0][1]]),b.push([a[1][0]+1,a[1][1]+1]),b.push([a[2][0],a[2][1]]),b.push([a[3][0]-1,a[3][1]+1])):3===f?(b.push([a[0][0],a[0][1]]),b.push([a[1][0]-1,a[1][1]-1]),b.push([a[2][0],a[2][1]+2]),b.push([a[3][0]-1,a[3][1]+1])):4===f&&(b.push([a[0][0]+1,a[0][1]-1]),b.push([a[1][0],a[1][1]]),b.push([a[2][0]-1,a[2][1]-1]),b.push([a[3][0]-2,a[3][1]]));return b},Q=function(a){var b=[];1===f?(b.push([a[0][0]+1,a[0][1]+1]),b.push([a[1][0],a[1][1]]),
b.push([a[2][0]-1,a[2][1]+1]),b.push([a[3][0]-2,a[3][1]])):2===f?(b.push([a[0][0],a[0][1]-2]),b.push([a[1][0],a[1][1]]),b.push([a[2][0]-1,a[2][1]-1]),b.push([a[3][0]-1,a[3][1]+1])):3===f?(b.push([a[0][0]+2,a[0][1]]),b.push([a[1][0]+1,a[1][1]-1]),b.push([a[2][0],a[2][1]]),b.push([a[3][0]-1,a[3][1]-1])):4===f&&(b.push([a[0][0]+1,a[0][1]-1]),b.push([a[1][0]+1,a[1][1]+1]),b.push([a[2][0],a[2][1]]),b.push([a[3][0],a[3][1]+2]));return b},P=function(a){var b=[];1===f?(b.push([a[0][0]+1,a[0][1]-1]),b.push([a[1][0]+
2,a[1][1]+2]),b.push([a[2][0]+1,a[2][1]+1]),b.push([a[3][0],a[3][1]])):2===f?(b.push([a[0][0]+1,a[0][1]+1]),b.push([a[1][0],a[1][1]]),b.push([a[2][0]-1,a[2][1]+1]),b.push([a[3][0]-2,a[3][1]+2])):3===f?(b.push([a[0][0],a[0][1]]),b.push([a[1][0]-1,a[1][1]-1]),b.push([a[2][0]-2,a[2][1]-2]),b.push([a[3][0]-1,a[3][1]+1])):4===f&&(b.push([a[0][0]+2,a[0][1]-2]),b.push([a[1][0]+1,a[1][1]-1]),b.push([a[2][0],a[2][1]]),b.push([a[3][0]-1,a[3][1]-1]));return b},O=function(a){var b=[];1===f?(b.push([a[0][0]+2,
...
1===f||3===f?(b.push([a[0][0]-1,a[0][1]+1]),b.push([a[1][0],a[1][1]]),b.push([a[2][0]+1,a[2][1]-1]),b.push([a[3][0]+2,a[3][1]-2])):(b.push([a[0][0]+1,a[0][1]-1]),b.push([a[1][0],a[1][1]]),b.push([a[2][0]-1,a[2][1]+1]),b.push([a[3][0]-2,a[3][1]+2]));return b},S=function(a){" "===a.key&&(z=1E3)},B=function(a){var b=[],c=r();if(-1!==a||!c.some(function(a){return 0===Number(a.id.charAt(0))}))if(1!==a||!c.some(function(a){return 9===Number(a.id.charAt(0))})){for(var F=$jscomp.makeIterator(c),d=F.next();!d.done;d=
F.next()){var f=$jscomp.makeIterator(m(d.value.id)),d=f.next().value,f=f.next().value;if(2===e[d+a][f])return}c.forEach(function(a){var c=$jscomp.makeIterator(m(a.id));a=c.next().value;c=c.next().value;document.getElementById(a+"-"+c).classList.remove("moving");e[a][c]=0;b.push([a,c])});b.forEach(function(b){document.getElementById(b[0]+a+"-"+b[1]).classList.add("moving");G(document.getElementById(b[0]+"-"+b[1]),document.getElementById(b[0]+a+"-"+b[1]),"moving");e[b[0]+a][b[1]]=1})}},T=function(){h||
(k=d=!0,document.getElementById("nextPieceImage").classList.remove("hidden"),H())},V=function(){for(var a=0,b=19;0<=b;b--){for(var c=0,d=0;10>d;d++)2===e[d][b]&&c++;if(10===c){c=b;for(d=0;10>d;d++)e[d][c]=0,document.getElementById(d+"-"+c).classList.remove("placed");c=b;for(d=19;0<=d;d--)for(var f=0;10>f;f++)if(!(d>c))if(d<=c&&0!==d){document.getElementById(f+"-"+d).classList.remove("placed");e[f][d]=e[f][d-1];var g=U(f,d);2===e[f][d]&&(document.getElementById(f+"-"+d).classList.add("placed"),document.getElementById(f+
"-"+d).classList.add(g))}else document.getElementById(f+"-"+d).classList.remove("placed"),e[f][d]=0,y(document.getElementById(f+"-"+d));b++;a++}}switch(a){case 1:p+=40;break;case 2:p+=100;break;case 3:p+=300;break;case 4:p+=1200}document.getElementById("points").textContent=p},H=function(){k?(A(!1),x=!0):l&&(W(),x=!1);n&&X();window.sleep(z).then(function(){d&&!h&&H()})},C=function(){r().forEach(function(a){var b=$jscomp.makeIterator(m(a.id)),c=b.next().value,b=b.next().value;y(a);a.classList.remove("moving");
e[c][b]=0})},D=function(){var a=document.getElementById("heldPieceImage");switch(q){case "st":a.src="images/st.jpeg";break;case "sq":a.src="images/sq.jpeg";break;case "rl":a.src="images/rl.png";break;case "tt":a.src="images/tt.png";break;case "ml":a.src="images/ml.png";break;case "rz":a.src="images/rz.png";break;case "mz":a.src="images/mz.png"}},A=function(a,b){var c;if(a)c=b;else{c=w;do w=window.randomIntFromInterval(0,6);while(w===c);var d=document.getElementById("nextPieceImage");switch(w){case 0:d.src=
"images/st.jpeg";break;case 1:d.src="images/sq.jpeg";break;case 2:d.src="images/rl.png";break;case 3:d.src="images/tt.png";break;case 4:d.src="images/ml.png";break;case 5:d.src="images/rz.png";break;case 6:d.src="images/mz.png"}}if(Y(c))h=!0,window.closableModal("Game Over!");else{switch(c){case 0:case "st":for(c=0;4>c;c++)document.getElementById("2-"+c).classList.add("moving"),document.getElementById("2-"+c).classList.add("cyan"),e[2][c]=1;g="st";break;case 1:case "sq":for(c=0;2>c;c++)document.getElementById("2-"+
...
c).classList.add("red"),e[2][c]=1;for(c=0;2>c;c++)document.getElementById("1-"+(c+1)).classList.add("moving"),document.getElementById("1-"+(c+1)).classList.add("red"),e[1][c+1]=1;g="mz"}k=!1;l=!0}},Y=function(a){if(0===a)return 0!==e[2][0]||0!==e[2][1]||0!==e[2][2]||0!==e[2][3];if(1===a)return 0!==e[2][0]||0!==e[2][1]||0!==e[3][0]||0!==e[3][1];if(2===a)return 0!==e[2][0]||0!==e[2][1]||0!==e[2][2]||0!==e[3][2];if(3===a)return 0!==e[2][0]||0!==e[2][1]||0!==e[2][2]||0!==e[1][1];if(4===a)return 0!==e[2][0]||
0!==e[2][1]||0!==e[2][2]||0!==e[1][2];if(5===a)return 0!==e[2][0]||0!==e[2][1]||0!==e[3][1]||0!==e[3][2];if(6===a)return 0!==e[2][0]||0!==e[2][1]||0!==e[1][1]||0!==e[1][2]},W=function(){var a=r();if(Z(a))l=!1,n=!0;else{var b=[];a.forEach(function(a){var c=$jscomp.makeIterator(m(a.id));a=c.next().value;c=c.next().value;document.getElementById(a+"-"+c).classList.remove("moving");e[a][c]=0;b.push([a,c])});b.forEach(function(a){document.getElementById(a[0]+"-"+(a[1]+1)).classList.add("moving");e[a[0]][a[1]+
1]=1;G(document.getElementById(a[0]+"-"+a[1]),document.getElementById(a[0]+"-"+(a[1]+1)),"moving")})}},K=function(){var a=[];for(r().forEach(function(b){var c=$jscomp.makeIterator(m(b.id));b=c.next().value;c=c.next().value;a.push([b,c])});aa(a);)a.forEach(function(a){a[1]+=1});ba(a)},ba=function(a){C();a.forEach(function(a){var b=document.getElementById(a[0]+"-"+a[1]);b.classList.add("moving");e[a[0]][a[1]]=1;switch(g){case "st":b.classList.add("cyan");break;case "sq":b.classList.add("yellow");break;
case "rl":b.classList.add("orange");break;case "tt":b.classList.add("blue");break;case "ml":b.classList.add("green");break;case "rz":b.classList.add("purple");break;case "mz":b.classList.add("red")}})},aa=function(a){var b=!0;a.forEach(function(a){if(19===a[1]||2===e[a[0]][a[1]+1])b=!1});return b},Z=function(a){var b=!1;a.forEach(function(a){var c=$jscomp.makeIterator(m(a.id));a=c.next().value;c=c.next().value;if(19===c||2===e[a][c+1])b=!0});return b},X=function(){r().forEach(function(a){a.classList.remove("moving");
a.classList.add("placed");var b=$jscomp.makeIterator(m(a.id));a=b.next().value;b=b.next().value;e[a][b]=2});V();n=!1;k=!0;f=1},m=function(a){a=a.split("-");return[Number(a[0]),Number(a[1])]},y=function(a){a.classList.contains("blue")?a.classList.remove("blue"):a.classList.contains("red")?a.classList.remove("red"):a.classList.contains("yellow")?a.classList.remove("yellow"):a.classList.contains("green")?a.classList.remove("green"):a.classList.contains("cyan")?a.classList.remove("cyan"):a.classList.contains("purple")?
a.classList.remove("purple"):a.classList.contains("orange")&&a.classList.remove("orange")},U=function(a,b){var c=document.getElementById(a+"-"+b),d=document.getElementById(a+"-"+(b-1));y(c);if(d.classList.contains("blue"))return"blue";if(d.classList.contains("red"))return"red";if(d.classList.contains("yellow"))return"yellow";if(d.classList.contains("green"))return"green";if(d.classList.contains("cyan"))return"cyan";if(d.classList.contains("purple"))return"purple";if(d.classList.contains("orange"))return"orange"},
G=function(a,b,c){a.classList.contains("blue")?(b.classList.add("blue"),a.classList.contains(c)||a.classList.remove("blue")):a.classList.contains("red")?(b.classList.add("red"),a.classList.contains(c)||a.classList.remove("red")):a.classList.contains("yellow")?(b.classList.add("yellow"),a.classList.contains(c)||a.classList.remove("yellow")):a.classList.contains("green")?(b.classList.add("green"),a.classList.contains(c)||a.classList.remove("green")):a.classList.contains("cyan")?(b.classList.add("cyan"),
a.classList.contains(c)||a.classList.remove("cyan")):a.classList.contains("purple")?(b.classList.add("purple"),a.classList.contains(c)||a.classList.remove("purple")):a.classList.contains("orange")&&(b.classList.add("orange"),a.classList.contains(c)||a.classList.remove("orange"))},ca=function(){var a=document.getElementById("ctrlList"),b=document.getElementById("hideBtn");a.classList.contains("hidden")?(a.classList.remove("hidden"),b.textContent="Hide"):(a.classList.add("hidden"),b.textContent="Show")};
(function(){for(var a=0;10>a;a++){var b=document.createElement("div");b.id="col-"+a;b.classList.add("col");I.appendChild(b);e.push([]);for(var c=0;20>c;c++){var d=document.createElement("div");d.id=a+"-"+c;d.classList.add("cell");b.appendChild(d);e[a].push(0)}}document.getElementById("startBtn").addEventListener("click",T);document.addEventListener("keydown",L);document.addEventListener("keyup",S);document.getElementById("hideBtn").addEventListener("click",ca);document.getElementById("points").textContent=
